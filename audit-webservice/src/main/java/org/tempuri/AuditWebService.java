 ...
 * 
 */
@WebServiceClient(name = "AuditWebService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://192.18.100.47/AuditWebService.asmx?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.18.100.47/AuditWebService.asmx?wsdl");
