 ...
 */
public class BigFileParser1 {

    private static final Logger logger = LoggerFactory.getLogger(BigFileParser1.class);
...
//        logger.info("parseRowData, row={}, rowData={}", row, rowData);
    ...
    public static void main(String[] args) {
        BigFileParser1 bigFileParser = new BigFileParser1();
