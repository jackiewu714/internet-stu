...
//		genInsertXml(introspectedTable, answer, sb);
		...
		genInsertAllXml(introspectedTable, answer, sb);
		return true;
	}
	 ...
	 */
	protected void genInsertAllXml(IntrospectedTable introspectedTable, XmlElement answer, StringBuilder sb) {
