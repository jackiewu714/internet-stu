 ...
 * 
 */
@WebServiceClient(name = "HelloWSService", targetNamespace = "http://www.tmp.com/services/hello", wsdlLocation = "http://localhost:8999/services/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSSERVICE_QNAME = new QName("http://www.tmp.com/services/hello", "HelloWSService");
